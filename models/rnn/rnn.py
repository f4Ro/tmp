...
def create_model(
    sequence_length: int, n_dims: int, batch_size: int,
    activation: str = 'tanh', recurrent_activation: str = 'sigmoid',
    kernel_regularizer = l2(0.0), bias_regularizer = l2(0.0), activity_regularizer = l2(0.0),
    dropout: float =0.0, recurrent_dropout: float = 0.0,
    ):
...
own_callback = CustomCallback(num_epochs,
                              plotter=harry,
                              batch_size=batch_size,
